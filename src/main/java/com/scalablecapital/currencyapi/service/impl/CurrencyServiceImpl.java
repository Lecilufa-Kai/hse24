...
public class CurrencyServiceImpl implements CurrencyService {
    ...
    private static final String LINK_TEMPLATE = "https://www.ecb.europa.eu/stats/policy_and_exchange_rates/euro_reference_exchange_rates/html/eurofxref-graph-%s.en.html";
    ...
    public @NotNull ReferenceRateDto getCurrenciesReferenceRate(
        ...
        //use a thread to update visits,the call return immediately,not blocking main thread.
    ...
    private CurrencyConversionDto buildCurrencyConversion(
        Currency sourceCurrency,
        Currency targetCurrency,
        double sourceAmount
    ) {
